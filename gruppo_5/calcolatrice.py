...
def sottrazione(primo_numero, secondo_numero):
    ...
    return f"La sottrazione tra {primo_numero} e {secondo_numero} è uguale a {primo_numero - secondo_numero}"
...
def divisione(primo_numero, secondo_numero):
    if secondo_numero == 0 :
        return "Divisione per 0 non possibile"
    else:
        return primo_numero / secondo_numero


risposta = ""
while risposta != "q": #quit
    print("a) Addizione")
    print("s) Sottrazione")
